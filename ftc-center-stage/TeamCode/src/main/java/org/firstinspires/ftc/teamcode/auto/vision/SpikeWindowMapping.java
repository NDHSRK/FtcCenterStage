...
public class SpikeWindowMapping {
    ...
    private static final String TAG = SpikeWindowMapping.class.getSimpleName();

    private final String imageDirectory;

    public SpikeWindowMapping() {
    ...
    public Mat overlaySpikeWindows(ImageProvider pImageProvider,
                                   ...
                                   SpikeWindowMappingXML.SpikeWindowData pTeamPropData) throws InterruptedException {
        ...
        Mat imageROI = ImageUtils.preProcessImage(teamPropImage.first, outputFilenamePreamble, pTeamPropData.imageParameters);
        drawSpikeWindows(imageROI, pTeamPropData.spikeWindows, outputFilenamePreamble);
        return imageROI;
    }
